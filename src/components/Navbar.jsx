        ...
        <nav className="flex justify-between mt-6 ml-6 md:ml-80 60 mr-6 md:mr-80 h-14 items-center rounded-full shadow-lg border border-gray-300 bg-white">
            <div className="max-w-7xl mx-auto md:ml-[-84px] md:pr-10 md:w-[900px]">
                <div className="flex justify-between items-center h-16">
                    <div className="flex-shrink-0 inline-flex space-x-[180px] w-[350px]">
                        <img className='h-8 cursor-pointer ml-[20px] md:hidden' src={navlogo} alt="Logo" />
                        <FiAlignJustify className='mt-2 md:hidden' onClick={toggleSidebar} />
                    </div>
                    <div className="hidden md:flex ml-[-210px] space-x-4 items-center">
                        ...
                        <a href="#" className="text-blue-900 hover:bg-blue-300 hover:text-gray-900 px-3 py-2 rounded-full text-sm font-medium transition duration-300 ease-in-out">OurMission</a>
                        ...
                        <a href="#" className="text-blue-900 px-3 py-2 rounded-full text-sm font-medium transition duration-300 ease-in-out hover:bg-blue-300 hover:text-gray-900 focus:bg-blue-300 focus:text-gray-900 active:bg-blue-300 active:text-gray-900">JoinWaitlist</a>
                    </div>
                </div>
            </div>
