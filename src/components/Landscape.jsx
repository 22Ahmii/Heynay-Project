...
export default function Landscape() {
    return (
        <div className="flex flex-col lg:flex-row mt-10 items-center justify-center lg:justify-start">
           ...
           < img src={vector1} alt="vector" className=" h-7 md:lg:ml-[160px] md:2xl:ml-[320px] md:lg:h-10 md:lg:p-0 top-[-100px] md:lg:top-[-630px]  " />
            <img src={image1} alt="image1" className=" h-4 md:lg:ml-[170px]  md:2xl:ml-[330px] md:lg:h-6 md:lg:p-0 md:lg:mt-[-30px] md:2xl:mt-[-30px] top-[-200px] md:lg:top-[-630px] " />
