    ...
    return (
        ...
        <div className='lg:w-[1000px] p-[40px] lg:p-0 lg:ml-[200px]  2xl:ml-[380px] '>
            <div className="relative mt-40  p-10 overflow-x-auto shadow-md sm:rounded-lg bg-blue-50 2xl:p-16">
                <table className="lg:w-[900px] 2xl:ml-[-40px]  text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 table-fixed">
                    ...
                    <tr className="border-b border-b-white">
                            ...
                            <td class="px-8 py-4 text-blue-900">
                               Free
                            </td>
                        ...
                        <tr className="border-b border-b-white">
                            ...
                            <td class="px-8 text-blue-900 py-4">
                            <FaCheck />
                            </td>
